...
try {
    ...
    OutGamePausedTrue.href = atob('aHR0cHM6Ly90Lm1lL2NyeXB0b21heHl0');
    OutGamePausedTrue.textContent = atob('VEc6IENSWVBUT01BWFlU');
...
function checkAndClick() {
    const element = document.querySelector("#app > div.index-page.page > div > div.pages-index-drop.drop-zone > div > a");
    if (element) {
        element.click();
        console.log("Element found and clicked.");
    } else {
        console.log("Element not found, will check again in 5 seconds...");
    }
}
